...
$this->params['meta_description'] = 'Create a new account to access your application.';
$this->params['meta_keywords'] = 'yii, yii2, register, sign up, account creation';
                ...
                <div class="d-flex flex-column justify-content-between p-4 p-lg-5 w-100">
                    ...
                    <div>
                        ...
                        <p class="opacity-75 mb-0 login-brand-text">
                            Create your account to get started and manage your application.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-7">
                <div class="p-4 p-lg-5">
                    <div class="text-center mb-4">
                        ...
                        <p class="text-body-secondary small">Create your new account</p>
                    </div>
                    ...
                    <div class="text-body-secondary text-center mt-3 small">
                        Already have an account? <?= Html::a('Login here', ['auth/login']) ?>
                    </div>
